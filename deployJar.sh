...
mvn deploy:deploy-file -DgroupId=soot -DartifactId=soot -Dversion=FAUX -Dpackaging=jar -Dfile=./lib/sootclasses-trunk.jar -Durl=http://10.8.0.100:6397/nexus-webapp-1.9/content/repositories/3rdpartysnapshots/ -DrepositoryId=nexus
